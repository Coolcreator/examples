# Аналог unix-pipline с использованием Golang

Ex: grep 127.0.0.1 | awk '{print $2}' | sort | uniq -c | sort -nr

Реализованы:
Функция ExecutePipeline обеспечивает нам конвейерную обработку функций-воркеров, которые что-то делают.
Функции-воркеры, которые считают нам какую-то условную хеш-сумму от входных данных
